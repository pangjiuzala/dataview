...
(function ()
{
    ...
    e = function (t)
    {
        ...
        e = this.width = i(t.canvas, "Width") || t.canvas.width,
        n = this.height = i(t.canvas, "Height") || t.canvas.height;
        return e = this.width = t.canvas.width,
    ...
    b = (s.generateLabels = function (t, i, e, s)
    {
    ...
    }, s.easingEffects =
        {
            ...
            {
                return (t /= 1) < 1 / 2.75 ? 1 * (7.5625 * t * t) : 2 / 2.75 > t ? 1 * (7.5625 * (t -= 1.5 / 2.75) * t + .75) : 2.5 / 2.75 > t ? 1 * (7.5625 * (t -= 2.2
                        5 / 2.75) * t + .9375) : 1 * (7.5625 * (t -= 2.625 / 2.75) * t + .984375)
            },
    ...
    {
        var i = t.parentNode,
        e = parseInt(R(i, "padding-left")) + parseInt(R(i, "padding-right"));
        return i.clientWidth - e
    },
    A = s.getMaximumHeight = function (t)
    {
        var i = t.parentNode,
        e = parseInt(R(i, "padding-bottom")) + parseInt(R(i, "padding-top"));
        return i.clientHeight - e
    },
    ...
    a(e.Type.prototype,
    {
        ...
        stop : function ()
        {
            return e.animationService.cancelAnimation(this),
            this
        },
        resize : function (t)
        {
            ...
            s = this.options.maintainAspectRatio ? e / this.chart.aspectRatio : A(this.chart.canvas);
        ...
        render : function (t)
        {
            if (t && this.reflow(), this.options.animation && !t)
            {
                ...
                i.numSteps = this.options.animationSteps,
                i.easing = this.options.animationEasing,
                i.render = function (t, i)
                {
                    var e = s.easingEffects[i.easing],
                    n = i.currentStep / i.numSteps,
                    o = e(n);
                    t.draw(o, n, i.currentStep)
                },
                i.onAnimationProgress = this.options.onAnimationProgress,
                i.onAnimationComplete = this.options.onAnimationComplete,
                e.animationService.addAnimation(this, i)
            }
            else
                ...
                if (this.activeElements = t, this.draw(), this.options.customTooltips && this.options.customTooltips(!1), t.length > 0)
                    if (this.datasets && this.datasets.length > 1)
                    {
                        ...
                        d = function (t)
                        {
                            ...
                            {
                                i = t.points || t.bars || t.segments,
                                i[h] && i[h].hasValue() && l.push(i[h])
                            }
                            ),
                            s.each(l, function (t)
                            {
                        ...
                        new e.MultiTooltip(
                        {
                            ...
                            title : C(this.options.tooltipTitleTemplate, t[0]),
                            chart : this.chart,
                            ctx : this.chart.ctx,
    ...
    e.Arc = e.Element.extend(
        {
            inRange : function (t, i)
            {
                ...
                h = o > a ? a >= n || n >= o : n >= o && a >= n,
                l = e.distance >= this.innerRadius && e.distance <= this.outerRadius;
                return h && l
            },
            tooltipPosition : function ()
            {
    ...
    e.Tooltip = e.Element.extend(
        {
            draw : function ()
            {
                ...
                this
                .x + e / 2 > this.chart.width ? this.xAlign = "left" : this.x - e / 2 < 0 && (this.xAlign = "right"),
    ...
    e.Scale = e.Element.extend(
        {
            ...
            calculateXLabelRotation : function ()
            {
                ...
                if (this.xScalePaddingRight = s / 2 + 3, this.xScalePaddingLeft = e / 2 > this.yLabelWidth ? e / 2 : this.yLabelWidth, this.xLabelRotation = 0, this.display)
                {
                    ...
                    this.xLabelWidth = o;
                    for (var a = Math.floor(this.calculateX(1) - this.calculateX(0)) - 6; this.xLabelWidth > a && 0 === this.xLabelRo
                        tation || this.xLabelWidth > a && this.xLabelRotation <= 90 && this.xLabelRotation > 0; )
            ...
            draw : function ()
            {
                ...
                this.display && (t.fillStyle = this.textColor, t.font = this.font, n(this.yLabels, function (n, o)
                    ...
                    }, this), n(this.xLabels, function (i, e)
                    {
                        ...
                        a && (t.move
                            To(n, this.endPoint), t.lineTo(n, this.startPoint - 3), t.stroke(), t.closePath()),
                        t.lineWidth = this.lineWidth,
                        t.strokeStyle = this.lineColor,
                        t.beginPath(),
                    ...
                    if (n(this.yLabels, function (i, e)
                            ...
                            }, this), !this.lineArc)
                        {
                            ...
                            for (var i = this.valuesCount - 1; i >= 0; i--)
                            {
                                ...
                                {
                                    null == e && (e = this.calculateCenterOffset(this.max)),
                                    null == s && (s = this.getPointPosition(i, e));
                                    var o = this.getPointPosition(0 === i ? this.valuesCount - 1 : i - 1, e),
                                    a = this.getPointPosition(i === this.valuesCount - 1 ? 0 : i + 1, e),
                                    h =
                                    {
                                        x : (o.x + s.x) / 2,
                                        y : (o.y + s.y) / 2
                                    ...
                                    t.lineTo(s.x, s.y),
                                    t.lineTo(l.x, l.y),
                                    t.fillStyle = this.backgroundColors[i],
                                    t.fill(),
                                    t.closePath()
                                }
                                var r = this.getPointPosition(i, this.calculateCenterOffset(this.max) + 5);
                                t.font = W(this.pointLabelF
                                        ontSize, this.pointLabelFontStyle, this.pointLabelFontFamily),
                                ...
                                p = d > i || i > c - d,
                                f = i === d || i === c - d;
                                0 === i ? t.textAlign = "center" : i === u ? t.textAlign = "center" : u > i ? t.textAlign = "left" : t.textAlign = "right",
                                f ? t.textBaseline = "middle" : p ? t.textBaseline = "bottom" : t.textBaseline = "top",
                                t.fillText(this.labels[i], r.x, r.y)
                            }
                        }
                }
            }
    ...
    e.animationService =
    {
        ...
        addAnimation : function (t, i)
        {
            ...
            1 == this.animations.length && s.requestAnimFrame.call(window, this.digestWrapper)
        },
        ...
        startDigest : function ()
        {
            ...
            this.animations.length > 0 && s.requestAnimFrame.call(window, this.digestWrapper)
        }
    },
...
).call(this), function ()
{
    ...
    i.Type.extend(
    {
        ...
        initialize : function (t)
        {
            ...
            e.each(t.datasets, function (i, s)
            {
                var n =
                {
                    label : i.label || null,
...
.call(this), function ()
{
    ...
    i.Type.extend(
    {
        ...
        initialize : function (t)
        {
            ...
            e.each(t, function (i, e)
            {
                i.color || (i.color = "hsl(" + 360 * e / t.length + ", 100%, 50%)"),
                this.addData(i, e, !0)
            }, this),
            this.render()
        },
        ...
        addData : function (t, e, s)
        {
            ...
            "undefined" == typeof t.color && (t.color = i.defaults.global.segmentColorDefault[n % i.defaults.global.segmentColorDefault.length], t.highlight = i.defaults.global.segmentHighlightColorDefaults[n % i.defaults.global.segmentHighlightColorDefaults.length]),
...
.call(this), function ()
{
    ...
    s =
    {
        ...
        datasetFill : !0,
        legendTemplate : '<ul class="<%=name.toLowerCase()%>-legend"><% for (var i=0; i<datasets.lenth; i++){%><li><span style="background-color:<%=datasets[i].strokeColor%>"><%if(datasets[i].label){%><%=datasets[i].label%><%}%></span></li><%}%></ul>',
        offsetGridLines : !1
    };
    i.Type.extend(
    {
            ...
            this.scale && (this.scale.draw(i), e.each(this.datasets, function (t)
                {
                    ...
                    this.options.datasetStroke && s.stroke(),
            ...
            this.segments.splice(s, 0, new this.SegmentArc(
                {
                    ...
                    c
                    ircumference : this.options.animateRotate ? 0 : this.scale.getCircumference(),
                    startAngle : 1.5 * Math.PI
                }
                )),
    ...
    i.Type.extend(
    {
        ...
        draw : function (t)
        {
            ...
            e.each(this.datasets, function (t)
            {
                ...
                this.options.datasetFill && s.fill(),
                e.each(t.points, function (t)
                {
                    t.hasValue() && t.draw()
                }
