...
/**
 * @author liuxing
 * @category query real-time data of stock,and transfer data to stockdata.jsp
 */
public class PredictStokcdataDao {
	
	private Connection conn;
	private static Predict result = null;

	public PredictStokcdataDao() throws Exception {
	...
	public ArrayList<Predict> findPredict(int idf) {
		...
		String sql = "SELECT * FROM stockdataresult where id=" + idf;
		try {
